...
def search_imgs(collections=["sentinel-2-l2a"],
    ...
    for item in items:
        try:
            ...
            if item_cloud_cover <= min_cloud_cover  and blank_ratio < min_blank_ratio:
                best_item = item
...
if __name__ == "__main__":
    ...
    parser.add_argument("--start_date", type=str, default="2020-01-01", help="Start date of the search")
    parser.add_argument("--end_date", type=str, default="2023-12-31", help="End date of the search")
    parser.add_argument("--cloud_cover", type=float, default=1, help="Cloud cover threshold")
    parser.add_argument("--threshold", type=float, default=0.3, help="Blank area threshold")
    parser.add_argument("--granule_id", type=str, default="48RYV", help="Granule ID")
